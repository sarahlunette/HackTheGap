...
Map.addLayer(sar_change, {'min': -5, 'max': 5, 'palette': ['blue', 'white', 'red']}, 'SAR Change')
Map.addLayer(final_stack.select('event_vulnerability'), {'min':0, 'max':1, 'palette':['green','orange','red']}, 'Event Vulnerability')
